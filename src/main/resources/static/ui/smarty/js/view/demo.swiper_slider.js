/** ********************************************** **
	...
	REQUIRED:
		CSS
		<link href="/ui/smarty/plugins/swiper/dist/css/swiper.min.css" rel="stylesheet" type="text/css" />

		JS
		<script type="text/javascript" src="/ui/smarty/plugins/swiper/dist/js/swiper.jquery.min.js"></script>
		<script type="text/javascript" src="/ui/smarty/js/view/demo.swiper_slider.js"></script>
*************************************************** **/
