...
public interface DeviceKindRepository extends JpaRepository<DeviceKind, Long> {
    List<DeviceKind> findByDeviceKindNameOrDeviceKindNameENOrDeviceKindNameCN(String  deviceKindName,String  deviceKindNameEN,String  deviceKindNameCN);
    List<DeviceKind> findByDeviceKindName(String  deviceKindName);

    List<DeviceKind> findByDeviceKindNameNot(String  notdeviceKindName);
}
