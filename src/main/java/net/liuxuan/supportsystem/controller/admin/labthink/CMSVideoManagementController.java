...
//                String comment = request.getParameter("comment");
                boolean cMSVideoExists = .checkCMSVideoExists(cmsVideoName);
                if (cMSVideoExists) {
