...
public class VideoController {
    ...
    @ResponseBody
    public void getVideoXml(@PathVariable Long id, HttpServletRequest request, HttpServletResponse response) {
        ...
        String originxml =
                "<vcastr>" +
                        ...
                        "<isAutoPlay>false</isAutoPlay>" +//是否影片自动开始播放,默认是true
...
//            return document.asXML();
            ResponseHelper.writeStringResponseAsXml(response, document.asXML());
...
//        return "";
    ...
    @RequestMapping(value = "/video/videoxml1/{id}", method = RequestMethod.GET)
    @ResponseBody
    public String getVideoXml1(@PathVariable Long id, HttpServletRequest request, HttpServletResponse response) {
